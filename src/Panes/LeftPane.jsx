...
//             setLocations(data.data); // Assuming data contains an array of location IDs
//         } catch (error) {
//             console.error('Error fetching locations:', error);
//         }
//     };
...
//                     <LocationCard key={index} title={`Location ${index + 1}`} content={locationId} subtitle={`Subtitle ${index + 1}`} />
//                 ))} */}
//                 {locations}
//                 {locations.map((location, index) => (
//                     <LocationCard 
